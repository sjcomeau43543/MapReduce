...
def scrape(url, filename, print_title, print_datetime, print_author, print_description):
	...
	for line in mas_txt.iter_lines():
		if "<h2 class=\'home-title\'>" in line:
			...
			if print_description: print 'DESCRIPTION:', description
			all_four = 1
